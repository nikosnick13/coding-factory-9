...
public class EuroToUsdConverter {
    ...
    public static void main(String[] args) {
        ...
        int inputEuros = 0;
        int totalCentsAndDollars = 0;
        int usaDollars = 0;
        int usaCents = 0;

        //Data Input from the user
        System.out.println("Please insert a rate in Euros:");
        inputEuros = scanner.nextInt();

        // Data Processing - Expressions
        totalCentsAndDollars = inputEuros * EURO_TO_USD_CONVERSION_RATE;
        usaDollars = totalCentsAndDollars / 100;
        usaCents = totalCentsAndDollars % 100 ;
